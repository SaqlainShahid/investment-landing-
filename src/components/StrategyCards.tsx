  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
      {strategies.map((strategy, index) => {
        ...
        // Calculate fallback metrics if missing
            ...
            <div className="p-4 sm:p-5">
              ...
              <div className="relative overflow-visible">
                <button
                  ...
                  onMouseEnter={e => {
                    const d = (e.currentTarget.nextSibling as HTMLElement);
                ...
                <div
                  className="absolute left-1/2 bottom-full mb-2 sm:left-0 sm:top-11 sm:bottom-auto z-40 w-11/12 max-w-xs sm:w-56 bg-white border border-gray-200 rounded-xl shadow-lg p-4 text-xs text-gray-700 space-y-2 hidden group-hover:block"
                  style={{ display: 'none', zIndex: 40, transform: 'translateX(-50%)', pointerEvents: 'auto' }}
                  tabIndex={-1}
                  role="dialog"
                  aria-label="Risk metrics details"
                >
